...
/*   Nedanst�ende taget fr�n "specen":
     ...
     i = tidssteg
     j = nodnummer
     m = id nummer f�r fl�de
     n = id nummer f�r fl�de
     min = minimum
     max = maximum
     x = det tidssteg som batchen fr�n Tidssteg 1 l�mnar Nod 1
     y = det tidssteg som batchen fr�n Tidssteg 2 l�mnar Nod 1
     z = det tidssteg som batchen fr�n Tidssteg i l�mnar Nod 1
     b = batchtid
