...
public class EditTimestepDialog extends javax.swing.JDialog
{
    private GUI c_gui;
    private EventHandlerClient c_eventHandlerClient;
    private Timesteplevel c_tsl;
    private int c_tslIndex;
    ...
    /** Creates new form */
    public EditTimestepDialog(javax.swing.JDialog parent, boolean modal,
	...
	txtName.setText(c_tsl.getLabel());
	...
	txtSteps.setText("" + c_tsl.getMaxTimesteps());
	if (c_tslIndex == 0)
	    txtSteps.setEnabled(false); //The top level timestep 'divedes' must be 1
	...
	try {
	    ...
	    c_gui.showWarningDialog("Edit Timesteplevel",
...
/*	if (!c_eventHandlerClient.changeTimesteplevel(c_tslIndex, txtName.getText(), steps))
	{
	    c_gui.showWarningDialog("Sorry!",
